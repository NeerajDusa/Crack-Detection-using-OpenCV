...
def main():
    ...
    if st.button("Process"):
        for image_file in image_filess:
            ...
            print("Size of image: ", imgsize, "pixels")
            print("Size of crack: ", sz, "pixels")
            print("Percentage of crack on image: ", (sz/imgsize)*100, "%")
            st.write("Size of image: ", imgsize, "pixels")
            st.write("Size of crack: ", sz, "pixels")
            st.write("Percentage of crack on image: ", (sz/imgsize)*100, "%")
            
            # st.write("Size of image: ")
            # st.write(imgsize, " pixels")
            # st.write("Size of crack: ")
            # st.write(sz)
            # st.write("Percentage of crack on image: ")
            # st.write((sz/imgsize)*100)

    
            if (sz/imgsize)*100 >= 10:
                st.subheader("It has a crack!")
            else:
                st.subheader("It doesnt have a crack!")
            # st.write("Percentage of crack on image: ", (sz/imgsize)*100, "%")
